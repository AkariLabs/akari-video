...
- **film-warm** — 黒をわずかに浮かせ、ハイライトを琥珀色へ寄せた暖色フィルム
- **mono** — 彩度を完全に除き、引き締まった階調に整えるモノクロ
- **silver-retain** — 元色をわずかに残しながら低彩度・高コントラストにする銀残し
- **vintage-fade** — 黒浮き・低彩度・黄転びで古いプリントの退色感を作るレトロ調
- **cool-clear** — 青寄りの色温度と軽いコントラストで白と空気感を澄ませる寒色調
- **night-neon** — 青紫の暗部と高彩度で人工光を際立たせるネオン夜景調
- **forest-soft** — 緑をわずかに足し、階調と彩度を柔らかく整える vlog 向け自然調
- **sunset-gold** — 強い暖色と橙のハイライトで夕景の金色を押し出すゴールド調
