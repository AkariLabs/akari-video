...
test('caption band and single-svg raster roots consume sprite transform variables', () => {
  ...
  const transform = 'transform:translate(var(--x, 0px), var(--y, 0px)) rotate(var(--rotate, 0deg)) scale(var(--scale-x, var(--scale, 1)), var(--scale-y, var(--scale, 1)));transform-origin:center;';
