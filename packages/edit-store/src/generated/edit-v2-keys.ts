...
export const ITEM_V2_KEYS = ["id","name","hidden","locked","at","duration","anchor","transform","opacity","blend","crop","adjust","perspective","motion","animator","keyframes","items","mask","erase","flip","source","audio","role","link","mute","gain_db","denoise","lowcut_hz","fade_in","fade_out","ducking","duck_db","duck_attack","duck_release","script","reading","caption_ref","provenance"] as const;
