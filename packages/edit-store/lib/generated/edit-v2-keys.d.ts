export declare const ITEM_V2_KEYS: readonly ["id", "name", "hidden", "locked", "at", "duration", "anchor", "transform", "opacity", "blend", "crop", "perspective", "motion", "animator", "keyframes", "items", "mask", "source", "role", "gain_db", "fade_in", "fade_out", "ducking", "script", "reading", "provenance"];
...
export declare const ITEM_SOURCE_V2_KEYS_BY_DEFINITION: {
    ...
    readonly itemSourceAudioMediaV2: readonly ["kind", "src", "in", "out"];
