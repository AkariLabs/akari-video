...
export declare const ITEM_V2_KEYS_BY_DEFINITION: {
    readonly itemV2Media: readonly ["id", "name", "hidden", "locked", "at", "duration", "anchor", "transform", "opacity", "blend", "crop", "adjust", "perspective", "motion", "animator", "keyframes", "items", "mask", "erase", "flip", "source", "audio"];
