...
![Agent skills: 21](https://img.shields.io/badge/agent_skills-21-ff8a00)
...
- **[Skills Catalog](./docs/skills.md)** — the 21-skill map: what each owns and what it connects to
...
- `skills/` — agent-side stage skills (21 of them)
