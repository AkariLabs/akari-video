...
![Agent skills: 24](https://img.shields.io/badge/agent_skills-24-ff8a00)
...
- **[Skills Catalog](./docs/skills.md)** — the 24-skill map: what each owns and what it connects to
...
- `skills/` — agent-side stage skills (24 of them)
