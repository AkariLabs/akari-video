...
![Agent skills: 25](https://img.shields.io/badge/agent_skills-25-ff8a00)
...
- **[Skills Catalog](./docs/skills.md)** — the 25-skill map: what each owns and what it connects to
...
- `skills/` — agent-side stage skills (25 of them)
