...
![Agent skills: 26](https://img.shields.io/badge/agent_skills-26-ff8a00)
...
- **[Skills Catalog](./docs/skills.md)** — the 26-skill map: what each owns and what it connects to
...
- `skills/` — agent-side stage skills (26 of them)
