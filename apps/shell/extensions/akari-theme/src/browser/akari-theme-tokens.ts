...
// （2026-07-30 導入）。設定ダイアログ（akari-settings-dialog の「開発者モード」節）が「ダーク / ライト」を
...
export const DARK = {
    ...
    placedTextOrange: '#fb923c',
    placedTextCyan: '#22d3ee',
    placedTextYellow: '#facc15',
    placedTextRed: '#f87171',
    bgDeep: '#050505',
    bg: '#0a0a0a',
    card: '#141414',
    elevated: '#1a1a1a',
...
export const LIGHT: AkariPalette = {
    ...
    placedTextOrange: '#c2410c',
    placedTextCyan: '#0e7490',
    placedTextYellow: '#a16207',
    placedTextRed: '#b91c1c',
    bgDeep: '#ececec',
    bg: '#ffffff',
    card: '#f5f5f5',
    elevated: '#e5e5e5',
