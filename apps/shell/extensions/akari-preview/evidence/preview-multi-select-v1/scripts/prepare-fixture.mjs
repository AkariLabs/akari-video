...
// Only a disposable copy is modified; three disjoint siblings plus a group.
...
for (const [id, x, y] of [['a', 40, 70], ['b', 210, 70], ['c', 380, 70], ['nested', 230, 240]]) {
...
edit.tracks = [leaf('a'), leaf('b'), leaf('c'), {
  id: 'g', at: 0, duration: 120, source: { kind: 'group' }, transform: { x: 0, y: 0 }, items: [leaf('nested')]
...
console.log(`prepared ${project} (three root siblings and a nested leaf; 1.5s)`);
