// CDP の小道具（caption-drag-and-icon-tools/scripts/cdp-lib.mjs の写し。元ファイルは読み取り専用）
...
export async function listTargets(port) { const response = await fetch(`http://127.0.0.1:${port}/json/list`, { signal: AbortSignal.timeout(30000) }); return response.json(); }
