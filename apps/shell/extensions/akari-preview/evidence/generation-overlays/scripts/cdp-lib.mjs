...
// This lane ran on a machine under very high load (load average > 400 from parallel
// lanes), so the per-call CDP timeout is raised well above the #36 lane's 20 s.
