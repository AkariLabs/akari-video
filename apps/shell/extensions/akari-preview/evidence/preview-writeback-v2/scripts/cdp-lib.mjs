// T3 (evidence/t3-filmstrip-lazy-realdata/scripts/cdp-lib.mjs) からの複製。差分なし
// （軽量 CDP クライアント。Node 組み込みの WebSocket/fetch のみに依存し、外部 npm 依存を追加しない）。
...
export class CDP {
  ...
  async connect(timeoutMs = 10000) {
    ...
    await new Promise((resolve, reject) => {
      ...
      this.ws.addEventListener('error', (e) => { clearTimeout(timer); reject(e); });
    });
