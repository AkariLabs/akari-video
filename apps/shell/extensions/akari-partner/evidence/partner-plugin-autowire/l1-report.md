...
claude 実体（実測に使用）: /Users/ryoma/.local/share/claude/versions/2.1.220（version 2.1.220、ホームディレクトリ差し替え下で symlink 経由・(a)(e)(f) は実 CLI 実行、(b)(c)(d) は呼び出し記録スタブに差し替え）
REPO_ROOT: /Users/ryoma/_edit/30_products/akari-video-wt/partner-plugin-autowire
...
- stub 呼び出し記録: `{"argv":"plugin install akari@akari --scope project","cwd":"/private/tmp/akari-plugin-autowire-l1/d-project"}`
- stdout:
```
...
- 結果: PASS
- exitCode: 0
- user-scope settings.json (before): `{"extraKnownMarketplaces":{"akari":{"source":{"source":"directory","path":"/Users/ryoma/_edit/30_products/akari-video-wt/partner-plugin-autowire"}}}}`
- user-scope settings.json (after): `{"extraKnownMarketplaces":{"akari":{"source":{"source":"directory","path":"/Users/ryoma/_edit/30_products/akari-video-wt/partner-plugin-autowire"}}}}`
- stdout:
```
