...
const ORDER = ['time', 'transform', 'crop', 'perspective', 'motion-summary', 'motion', 'motion-empty', 'animator', 'framing', 'freeze', 'generation', 'appearance', 'easing', 'content', 'style', 'timing', 'audio', 'knobs', 'telop', 'info'];
