...
function fixture(detail) {
    ...
    const widget = Object.assign(new Widget(), {
        dragListenerConfigs: new WeakMap(), dragListenerInstalled: new WeakSet(),
        expandedChipHitRect: element => element.getBoundingClientRect(),
        trackIdOfDrag: () => 'track-1', isTrackLocked: () => false,
        createDragGhost: element => element.cloneNode(),
        timelineTreeRows: [],
        detectAudioDoubleClick: () => false,
