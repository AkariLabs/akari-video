...
test('pending file reads never publish an empty timeline; superseded reads do not replace it',async()=>{
 ...
 fileService:{readFile:()=>new Promise(r=>release=r)},resolveLegacyEditForOpen:async s=>s,readEdit:()=>({tracks:[]}),refreshReferenceMediaUris:async()=>{},hydrateDocumentMotionReferences:async()=>{}});
