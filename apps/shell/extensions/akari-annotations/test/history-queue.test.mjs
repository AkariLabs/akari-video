...
test('rapid undo and redo wait for the previous write to finish',async()=>{
 ...
 const w=Object.assign(new Widget(),{historyActionTail:Promise.resolve(),timelineWriteTail:Promise.resolve(),async performUndoNow(){calls.push('undo:start');await Promise.resolve();calls.push('undo:end')},async performRedoNow(){calls.push('redo:start');await Promise.resolve();calls.push('redo:end')}});
