...
test('preview tree item selection highlights its rendered HTML/cut/layer chip',()=>{
 ...
 const w=Object.assign(new Widget(),{multiSelection:[],selectionKey:s=>s?s.kind==='cut'?'cut:'+s.index:s.kind+':'+s.id:'',cutItemIds:['cut-a'],layers:[{id:'video-a'}],overlays:[{id:'html-a'}],rawKeyframeItem:()=>undefined,strip:{querySelectorAll:()=>elements},trackHeaders:{querySelectorAll:()=>[]}});
