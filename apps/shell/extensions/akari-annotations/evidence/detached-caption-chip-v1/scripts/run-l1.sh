...
WORKSPACE=$(mktemp -d "/tmp/akari-detached-caption-chip-l1-workspace.XXXXXX")
USERDATA=$(mktemp -d "/tmp/akari-detached-caption-chip-l1-userdata.XXXXXX")
