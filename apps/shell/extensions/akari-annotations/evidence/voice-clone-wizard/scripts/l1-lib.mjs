...
export async function launch({ shellDir, electron, project, port, isoDir, fakeWav, homeDir }) {
    ...
    const isolatedEnv = { ...process.env, HOME: homeDir, AKARI_HOME: path.join(homeDir, '.akari'),
