...
.akari-daihon-row.active { background:color-mix(in srgb, #53d1bc 10%, transparent); border-left-color:#53d1bc; }
...
.akari-daihon-row.selected.active { border-left-color:#53d1bc; box-shadow:inset 3px 0 0 var(--akari-accent); }
