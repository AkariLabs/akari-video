...
The workflow ships as 26 agent-side skills. The [Skills Catalog](./skills.md) is the
...
| [contract-2026-09-13-generation-v0.md](./contract-2026-09-13-generation-v0.md) | Generation v0: placeholder clips, nine normalized input slots, sidecar metadata, model capabilities, state, planned videos, replacement, cost approval, and frame capture (Japanese) |
...
| [contract-2026-08-23-captions-emphasis-words-v0.md](./contract-2026-08-23-captions-emphasis-words-v0.md) | `emphasis_words[]` seat for word-level emphasis in the captions.json object root, including the `style_preset` written by Transcript word selection → 🎨 Template; the edit.json v1 seat remains a backward-compatible fallback |
...
| [contract-2026-09-06-cut-audio-split-v0.md](./contract-2026-09-06-cut-audio-split-v0.md) | Cut audio/video separation v0 — current model, three options, recommendation, and staged implementation (draft, pending decision) (Japanese) |
