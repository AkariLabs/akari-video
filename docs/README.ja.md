...
ワークフローは 26 のエージェント側スキルとして同梱されています。[スキルカタログ](./skills.ja.md)が
...
| [contract-2026-09-25-shape-item-v1.md](./contract-2026-09-25-shape-item-v1.md) | 図形アイテム v1 — 値で写す path・角の丸み・線の端・吹き出し・グラデーション・内側の枠線 |
...
| [contract-2026-09-25-asset-license-axes-v0.md](./contract-2026-09-25-asset-license-axes-v0.md) | 素材ライセンスの 2 軸 v0 — 商用利用・帰属表示・書き出し前の案内 |
| [contract-2026-09-25-photo-edit-v0.md](./contract-2026-09-25-photo-edit-v0.md) | 写真の非破壊編集 v0 — 確定マスク・消しゴムの線・反転 |
