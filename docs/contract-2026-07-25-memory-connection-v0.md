...
- 発端: オーナー対話（2026-07-25）。要旨: プロジェクトを事業 Wiki の中に入れるのは違うが
  ...
  好み・スタイルの記憶は分けたい。内部裁定の全文脈は akari-video-internal
  `planning/contract-2026-07-25-memory-and-style.md` §0-§1 を正本とする（本書は同裁定のうち
...
- 内部裁定の全文脈（系統 A / 系統 B の分離理由、4 層スコープとの整合）は
  akari-video-internal `planning/contract-2026-07-25-memory-and-style.md` §0-§1 を正本とする
...
- **`entry` の既定を `INDEX.md` にする理由**: `_edit/CLAUDE.md` の LLM Wiki パターンにおいて
  ...
  （internal `planning/contract-2026-07-25-memory-and-style.md` §1 準拠）
...
- 書き戻し（完了時に記憶ソースの Wiki 層へ要点サマリを書く動作。internal
  `planning/contract-2026-07-25-memory-and-style.md` §1「書き戻し」節が構想を持つが、本契約は
  読み取りのみを扱う）
