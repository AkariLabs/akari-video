...
生成後は [edit-lint](./review-and-fix.ja.md) が尺・重なり・参照切れを検査します。
...
- BGM・SFX も入れる → [編集計画を立てて実行する](./plan-your-edit.ja.md)（audio 計画は edit-plan が担当）
- 接続設定 → [接続と API キー](../how-to/connections.ja.md)
